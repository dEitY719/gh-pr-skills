...
## 왜 무조건인가 (dEitY719/dotfiles#1524)
...
"답할 게 없었다"는 이유로 PR 이 트레인에서 밀려난다 (PR dEitY719/dotfiles#1545 리뷰, agy BLOCKER).
...
보드가 붙은 repo 에서 GraphQL deprecation 때문에 **조용히 실패**한다 (dEitY719/dotfiles#326 Bug B,
...
### 왜 404 를 WARN 에서 떼어냈나 (dEitY719/dotfiles#1545 리뷰, agy FOLLOW-UP)
...
얻는다(같은 정보 손실이 dEitY719/dotfiles#1519 를 만들었다). `gh` 의 404 문구는
...
로 폴백해서 **에러 없이 엉뚱한 서버의 라벨을 지운다** (dEitY719/dotfiles#1403 / dEitY719/dotfiles#1407).
